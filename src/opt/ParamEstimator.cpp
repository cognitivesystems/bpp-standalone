...
double ParamEstimator::eval_bpp(const VectorX data)
{
  ...
  paramsPtr.get()->setAll(data[0], data[1], data[2], data[3], helt_rate, w_supported, data[4], neightbour_constant,
                          w_assignment, w_place_near, bin_height, min_box_size, w_item_in_the_bottom_area,
                          w_high_items_good_placed, generate_simulated_boxes, start_with_all_edges_as_fp, search_height,
                          search_width);
