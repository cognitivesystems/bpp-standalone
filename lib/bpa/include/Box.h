...
public:
   ...
   */
  Box(double length, double width, double height, double mass, std::string name, std::vector<std::string> labels,
      std::string material = "carton", std::string tool = "");
  ...
  std::vector<std::string>
      dependency; /* For palletization orders: dependency are the boxes which block the way of this box*/
